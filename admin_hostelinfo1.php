...
<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQM3k5hCxweb1AKnCkw3ltAZ9x3oNx_hsn6Hw&usqp=CAU"
     alt="">
     <!-- <img src="https://tse1.mm.bing.net/th?id=OIP.xLlL2Bnwp4GL-lrAhXl5WQHaEo&pid=Api&P=0&h=180" alt=""> -->
...
<main>
    ...
    $sql = "SELECT * FROM room_alloc_boys";
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            } elseif ($room_id >= 401 && $room_id <= 410) { // Corrected condition
                $floor4[$room_id] = $no_of_mem; // Corrected array
            }
        }
        echo "<div class='card'>";
        echo "<h2>Floor 1</h2>";
        ...
        echo "<div class='card'>";
        echo "<h2>Floor 4</h2>";
        foreach ($floor4 as $room_id => $no_of_mem) {
            echo "<p>Room $room_id: $no_of_mem members</p>";
        }
        echo "</div>";
    } else {
